    ...
    <section id="portfolio" className="bg-light-gray py-16 md:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <ScrollReveal className="mb-16 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-body-text">Take a look at some of our recent projects and see how we transform homes across the Twin Cities</p>
        </ScrollReveal>
